"""Punto de entrada: pipeline completo para el modelo semi-analitico L=2.

Si results/L2/posterior_samples_L2_SV.csv ya existe, se reutiliza esa
...
Uso:
    python run_L2.py                  # usa cache si existe
    python run_L2.py --force          # fuerza recalcular MLE+MCMC
"""
import argparse
import os
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Pipeline SV-AUKF L=2")
    ...
    print(f"\n[DONE] L2 -- resultados en: {result['results_dir']}")
