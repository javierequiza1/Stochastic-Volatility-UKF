...
def download_dataset(ticker: str = "SPY",
    ...
    yfinance se importa aquí dentro (no al nivel del módulo) para que el
    resto del paquete -- filtro, MLE, MCMC, diagnósticos -- no dependa de
    tener yfinance instalado cuando solo se trabaja con datos ya
    descargados.
    """
